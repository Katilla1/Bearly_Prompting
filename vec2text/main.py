...
class Prompt2OutputCollator:
    def __call__(self, features, return_tensors=None):
        ...
        for feature in features:
            ...
            input_ids.append(tf.convert_to_tensor(result_list))
            labels.append(tf.convert_to_tensor(feature['system_prompt']))
...
class Prompt2OutputTrainer(BaseTrainer):
    def generate(self, inputs: Dict, generation_kwargs: Dict) -> tf.Tensor:
